...
(function (webim) {
  ...
  var Msg = function (sess, isSend, seq, random, time, fromAccount, subType, fromAccountNick , fromAccountHeadurl) {
    console.log('sess, isSend, seq, random, time, fromAccount, subType, fromAccountNick, fromAccountHeadurl',sess, isSend, seq, random, time, fromAccount, subType, fromAccountNick, fromAccountHeadurl)  
